...
export default function ReportTable(){
    return(
        <div className="w-full rounded-xl border-[3px] border-dark_moss_green-200 p-8 space-y-8">
            ...
            <div className="table table-fixed w-full border-collapse text-center">
                <div className="table-header-group border-b-2 border-dark_moss_green-200 text-dark_moss_green-300">
                    <div className="table-row">
                        <div className="table-cell py-3 pl-4 text-left">Name</div>
                        <div className="table-cell py-3">Total</div>
                        <div className="table-cell py-3">On Process</div>
                        <div className="table-cell py-3">Hold</div>
                        <div className="table-cell py-3">Completed</div>
                    </div>
                </div>
