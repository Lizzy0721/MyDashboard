  ...
  return (
    <div className="w-full rounded-xl border-[3px] border-dark_moss_green-200 p-8 space-y-8">
      <div className="flex justify-between items-center">
        ...
        <button className="text-base bg-yellow-200 px-3 py-1 rounded-md text-amber-600 font-medium">
          View all
        </button>
      </div>
        ...
        <div className="table table-fixed m:w-full border-collapse text-center">
          ...
          <div className="table-row-group text-dark_moss_green-900">
            {dummyReports.map((item) => (
              <div
                key={item.id}
                className="table-row hover:bg-dark_moss_green-100"
              >
                <div className="table-cell py-3 pl-4 text-left font-bold">
                  {item.name}
                </div>
                <div className="table-cell py-3 font-medium">
                  {item.total.toString().padStart(2, "0")}
                </div>
                <div className="table-cell py-3 text-dark_moss_green-300">
                  {item.onProcess.toString().padStart(2, "0")}
                </div>
                <div className="table-cell py-3 text-dark_moss_green-300">
                  {item.hold.toString().padStart(2, "0")}
                </div>
                <div className="table-cell py-3 text-silver_lake_blue-700 font-semibold">
                  {item.completed.toString().padStart(2, "0")}
                </div>
              </div>
            ))}
          </div>
