...
export default function Sidebar({
  ...
  return (
    <div
      ref={sidebarRef}
      className={`${isOpen ? "flex" : "hidden"} lg:flex fixed z-50 lg:static min-w-56 min-h-full flex-col bg-white drop-shadow-md lg:drop-shadow-none lg:border-e-2 border-dark_moss_green-200 px-4`}
    >
