    ...
    return(
        <div className="w-full bg-inherit relative scroll-smooth p-8 space-y-4">
            ...
            <div className="w-full m-[0_auto] grid lg:flex gap-4">
                <CardStats Title="Pending Task" href="./public/assets/Avgust.jpeg" Number={120}/>
                <CardStats Title="On Process" href="./public/assets/Bkornblume.jpeg" Number={120}/>
                <CardStats Title="Resolved" href="./public/assets/Marcus.jpeg" Number={120}/>
                <CardStats Title="Hold Task" href="./public/assets/Yenisei.jpeg" Number={120}/>
            </div>
            ...
            <div className="w-full overflow-x-auto p-8 space-y-6">
